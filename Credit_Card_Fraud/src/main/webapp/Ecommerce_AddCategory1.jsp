...
<head>
<title>Add Category Status</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article"> 
          <h2 class="style4" style="color:#CC6600">Adding Category Status..</h2>
          <div class="clr"></div>          
          <div class="post_content">
            ...
            <p class="style37 style7">Category Already Exist..</p>							
							
							
				
                    </p>
			        <p>&nbsp;</p>
			        <p><a href="Ecommerce_AddCategory.jsp" class="style15 style38">Back</a><a href="Ecommerce_AddCategory.jsp" class="style8 style15"></a></p>
			        <p>
                      <%
			           ...
			           String dt = strDate + "   " + strTime;
										...
										if(!category.equals(""))
										{
												...
												connection.createStatement().executeUpdate(strQuery2);
														...
														%><p class="style37 style7">Category Added Successfully..</p>		
											
											
                    </p>
			        <p>&nbsp;</p>
			        <p><a href="Ecommerce_AddCategory.jsp" class="style15 style38">Back</a></p>
			        <%
											 }
											 else
											 {
														...
														%><p class="style37 style7">Please Input Category Name..</p>
			        <p class="style37">&nbsp;</p>
			        <a href="Ecommerce_AddCategory.jsp" class="style15 style38">Back</a>
			        </p>
			        <%
