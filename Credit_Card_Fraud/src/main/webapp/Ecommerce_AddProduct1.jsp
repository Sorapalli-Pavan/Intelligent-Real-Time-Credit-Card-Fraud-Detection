        ...
        <div class="article"> 
          ...
          <div class="post_content">
             <%
					...
					PreparedStatement ps = null; // Declare ps here
					File file1 = null;	
					try {
                  ...
                  <p class="style41"><a href="Ecommerce_AddProduct.jsp" class="style7 style46"><strong>Back</strong></a></p>
					...
					ps=connection.prepareStatement("insert into products(p_name,category,p_price,p_mfg,p_model,p_des,p_image,date,`rank`,site) values(?,?,?,?,?,?,?,?,?,?)");
