...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article"> 
          <h2 class="style4" style="color:#CC6600">All Website Products....</h2>
          <div class="clr"></div>          
  ...
  <tr>
   ...
   <td width="178"><div align="center" style="color:#660000"><b>Website</b></div></td>
...
<%
  ...
  <tr>
	  ...
	  <td><div align="center" style="color:#006699"><b><%=s10%></b></div></td>
	...
	<td><div align="center" style="color:#000000"><%=s4%></div></td>
     <td><div align="center" style="color:#000000"><%=s5%></div></td>
			   ...
			   <td><div align="center" style="color:#000000"><%=r%></div></td>
		  	   <td><div align="center"><a href="Admin_Reviews.jsp?p_Name=<%= s2%>&amp;p_Category=<%=s9%>&amp;site=<%=s10%>" class="style5">Reviews</a></div></td>
  </tr>
