...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article"> 
          <h2 class="style4" style="color:#CC6600">Financial Fraud Details For Expired Credit Card...</h2>
          <div class="clr"></div>          
	...
	try
	{
					  		...
					  		String query1="select max(vote) from financial_fraud_expiredcard where fraud_type='"+fraud_type+"' and bank='"+bank+"'"; 
			...
			%>
	  	    ...
	  	    <table width="572" border="1">
				 ...
				 String query="select * from financial_fraud_expiredcard where vote='"+vote+"' and fraud_type='"+fraud_type+"' and bank='"+bank+"'"; 
