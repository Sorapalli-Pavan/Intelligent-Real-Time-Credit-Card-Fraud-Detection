...
<head>
<title>Assign Expiry Date Status Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article"> 
          <h2 class="style4" style="color:#CC6600">Assigning Card Expiry Date Status..</h2>
          <div class="clr"></div>          
	 ...
	 try{
		...
		String query11 ="update creditcard set exp_date='"+date+"'  where b_name='"+typebank+"' and a_name='"+accountname+"' ";
		st11.executeUpdate (query11);
		
		Statement st1 = connection.createStatement();
		String query1 ="update creditcardrequest set exp_date='"+date+"'  where id="+id+" ";
		...
		%><br/><br/>Expiry Date Not Assigned..Please Try Agian..</p><br/><br/>
